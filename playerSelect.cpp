...
CPlayerSelect* CPlayerSelect::Create(void)
{
	...
	CPlayerModel* pModel = CPlayerModel::Create(D3DXVECTOR3(-85.0f, 180.0f, 100.0f), 0, true);
	pModel->SetRot(D3DXVECTOR3(0.0f, D3DX_PI * -0.125f, 0.0f));
	pModel = CPlayerModel::Create(D3DXVECTOR3(5.0f, 180.0f, 100.0f), 1, true);
	pModel->SetRot(D3DXVECTOR3(0.0f, D3DX_PI * -0.025f, 0.0f));
	pModel = CPlayerModel::Create(D3DXVECTOR3(92.0f, 180.0f, 100.0f), 2, true);
	pModel->SetRot(D3DXVECTOR3(0.0f, D3DX_PI * 0.025f, 0.0f));
	pModel = CPlayerModel::Create(D3DXVECTOR3(182.0f, 180.0f, 100.0f), 3, true);
	pModel->SetRot(D3DXVECTOR3(0.0f, D3DX_PI * 0.125f, 0.0f));
